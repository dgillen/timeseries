...
input_sample = pd.DataFrame({"date_time": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "holiday": pd.Series(["example_value"], dtype="object"), "temp": pd.Series([0.0], dtype="float64"), "rain_1h": pd.Series([0.0], dtype="float64"), "snow_1h": pd.Series([0.0], dtype="float64"), "clouds_all": pd.Series([0], dtype="int64"), "weather_main": pd.Series(["example_value"], dtype="object"), "weather_description": pd.Series(["example_value"], dtype="object")})
try:
